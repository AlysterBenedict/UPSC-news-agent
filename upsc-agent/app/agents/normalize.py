...
def normalize_articles(state: dict) -> dict:
    ...
    if settings.llm_classification_enabled and candidates:
        log.info(
        ...
        # Classification disabled — pass all candidates through
        normalized = candidates
        if not settings.llm_classification_enabled:
            log.info("llm_classification_disabled", passing_all=len(candidates))
